      ...
      xl:grid-cols-3 gap-5'>
        ...
        rounded-lg hover:bg-teal-50">
          ...
          <p className='text-sm text-gray-600'>
            ...
            Nam voluptatibus repellat sapiente provident quo nemo soluta beatae debitis amet odio. 
            Aperiam similique odio nobis quis? Quam ab reiciendis enim aspernatur?
          </p>
        </div>
